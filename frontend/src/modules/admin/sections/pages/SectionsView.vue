...
const visibleColumns = ref<SectionColumn[]>([
    'section',
    'year_level',
    'program',
    'semester',
...
const isColumnVisible = (column: SectionColumn) =>
...
const hasActiveFilters = computed(
    () =>
        ...
        filters.value.year_level !== null,
)

const { form, errors, validate, reset, applyServerErrors } =
    useResourceForm(sectionSchema, {
        semester_id: 0,
        program_id: 0,
        year_level: 1,
        name: 1,
...
async function loadOptions() {
    ...
    try {
        const [semesterResponse, programResponse] =
            await Promise.all([
                getSemesters(1, 100),
                getPrograms(1, 100),
            ])
        ...
        uiStore.showToast(
            'Failed to load section options.',
            'error',
        )
    }
}
...
function openCreate() {
    ...
    reset({
        semester_id:
            filters.value.semester_id ?? 0,
        program_id:
            filters.value.program_id ?? 0,
        year_level:
            filters.value.year_level ?? 1,
        name: 1,
    })
...
<template>
    <div class="mx-auto w-full max-w-360 space-y-6 px-6 py-6">
            ...
            >
                ...
                >
                    <div>
                        ...
                        <p
                            class="mt-0.5 text-xs text-text/45"
                        >
                ...
                <div class="space-y-0.5">
                    ...
                    >
                        ...
                        <span
                            class="flex-1 text-sm text-text/80"
                        >
                            {{ column.label }}
                        </span>
                        ...
                        <span
                            ...
                            class="text-[10px] font-medium text-text/35"
                        >
                            Always
                        </span>
                    </button>
                ...
                <div
                    class="mt-1 border-t border-border px-2 pt-2"
                >
        ...
        >
            <p
                class="flex-1 text-sm font-medium text-error"
            >
                {{ crud.error.value }}
            </p>
        ...
        >
            <div class="overflow-x-auto">
                <table
                    class="w-full min-w-215 border-collapse"
                >
                    <thead>
                        <tr
                    ...
                    >
                        ...
                        >
                            ...
                            <td class="px-4 py-4">
                                <div
                                    class="ml-auto h-8 w-8 animate-pulse rounded-md bg-text/5"
                                />
                            </td>
                        </tr>
                    </tbody>
                    ...
                    <tbody
                        v-else-if="
                            crud.currentList().length
                        "
                        class="divide-y divide-border"
                    >
                        <tr
                            v-for="section in crud.currentList()"
                            :key="section.id"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {{
                                        section.semester
                                            ? `Semester ${section.semester.name} · ${section.semester.academic_year}`
                                            : '—'
                                    }}
                                </span>
                            </td>
                            ...
                            >
                                <span
                                    class="font-mono text-xs tabular-nums text-text/60"
                                >
                                    {{
                                        section.created_at ||
                                        '—'
                        ...
                        <tr>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p
                                        class="mt-3 text-sm font-medium text-text"
                                    >
                                        {{
                                            emptyStateText
                                        }}
