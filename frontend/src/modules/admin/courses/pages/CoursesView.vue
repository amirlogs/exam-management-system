...
const visibleColumns = ref<CourseColumn[]>([
    'course',
    'code',
    'department',
    'credit_hours',
...
const hasActiveFilters = computed(() => {
    return (
        ...
        filters.value.credit_hours !== null
    )
})
...
<template>
    <div class="mx-auto w-full max-w-360 space-y-6 px-6 py-6">
        ...
        >
            ...
            <template #filters>
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <BaseSelect
                        v-model="filters.credit_hours"
                        label="Credit hours"
                        :options="creditHourOptions"
                        placeholder="All credit hours"
                    />
        ...
        >
            <div
                data-columns-menu
                class="absolute right-0 z-50 mt-[-12px] w-56 rounded-lg border border-border bg-surface p-2 shadow-lg"
            >
                <div class="flex items-center justify-between px-2 py-1.5">
                    ...
                    <button
                        type="button"
                        class="text-xs font-medium text-text/50 transition-colors hover:text-accent"
                        @click="resetColumns"
                    >
                        Reset
                    </button>
                ...
                <table class="w-full min-w-190 border-collapse">
                    ...
                    <thead>
                        <tr class="border-b border-border bg-text/2.5">
                            ...
                            <th
                                v-if="isColumnVisible('credit_hours')"
                                class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-text/50"
                            >
                                Credit Hours
                            </th>
                    ...
                    <tbody
                        v-else-if="crud.currentList().length"
                        class="divide-y divide-border"
                    >
                        <tr
                            v-for="course in crud.currentList()"
                            :key="course.id"
                    ...
                    <tbody v-else>
                        <tr>
                            <td
                                ...
                                class="px-6 py-16 text-center text-sm text-text/55"
                            >
                                {{ emptyStateText }}
                            </td>
                        </tr>
