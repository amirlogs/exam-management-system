      ...
      <div class="lg:col-span-8">
        <BaseCard :padded="false" class="rounded-xl border border-border overflow-hidden shadow-sm">
          ...
          <div v-if="activeTab === 'bank'" class="p-5">
            <input v-model="search" placeholder="Search questions…" class="w-full px-3 py-2.5 rounded-lg border border-border bg-bg text-sm mb-4" @input="loadBank" />
            <div class="divide-y divide-border max-h-[420px] overflow-y-auto">
              ...
              <p v-if="!bank.length" class="text-sm text-text/40 text-center py-8">No available questions.</p>
            </div>
          </div>
