...
<template>
  <div class="relative">
    ...
    <Teleport to="body">
      <div v-if="isOpen" data-dropdown-menu class="fixed z-[100] max-h-60 overflow-y-auto rounded-lg border border-border bg-surface py-1 shadow-lg" :style="menuStyle" @click.stop>
        <button
