...
<template>
  <div class="fixed top-6 right-6 z-50 space-y-2 w-80">
    <transition-group name="toast">
      <div v-for="toast in uiStore.toasts" :key="toast.id" :class="['flex items-start gap-2 rounded-md border p-3 shadow-lg bg-surface', styleFor[toast.variant] || styleFor.info]">
