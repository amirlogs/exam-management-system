...
<template>
  <div v-if="pagination.total > 0" class="flex flex-col gap-3 border-t border-border px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="flex items-center gap-1">
      ...
      <button
        ...
        :class="[
          ...
          page === pagination.current_page ? 'border-accent bg-accent/5 text-accent' : 'border-border text-text/60 hover:bg-text/5',
        ]"
