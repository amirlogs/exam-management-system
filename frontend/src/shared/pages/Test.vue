    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-bg font-sans text-text p-4 relative">
        ...
        <main class="w-full max-w-[400px]">
            ...
            <div class="bg-surface border border-border rounded-lg p-6 mb-6">
                ...
                <div class="flex flex-col items-center mb-8">
                    ...
                    <p class="text-xs text-text opacity-60 mt-1">
                        Institutional Login
                    </p>
                </div>
                ...
                <form @submit.prevent="handleSubmit" class="space-y-4">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input id="email" v-model="email" type="email" required placeholder="admin@university.edu"
                ...
                <div class="mt-4 text-center">
                    <a href="#"
                        class="text-xs text-accent hover:underline focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-1 rounded-sm">
                        Forgot password?
                    </a>
                </div>
            </div>
        ...
        <footer class="w-full text-center py-4 absolute bottom-0">
            <p class="text-xs text-text opacity-60">
                © {{ currentYear }} University Name. All rights reserved.
            </p>
        </footer>
    </div>
</template>
