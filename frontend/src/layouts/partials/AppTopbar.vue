...
<template>
  <header class="h-17 px-4 md:pl-6 md:pr-3 flex items-center justify-between border-b border-border bg-surface sticky top-0 z-20">
    <div class="flex items-center gap-3">
      <button class="md:hidden w-9 h-9 rounded-lg flex items-center justify-center hover:bg-bg" @click="toggleMobile">
    ...
    <div class="flex items-center gap-2">
      ...
      <button class="w-9 h-9 rounded-full flex items-center justify-center hover:bg-bg transition-colors relative">
