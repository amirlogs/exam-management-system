...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create([
            "name" => "approve_question_import",
            "category" => "question_bank",
            "description" => "Approve question bank import (Dept Head)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "exams",
            "description" =>
                "System checks lab booking conflicts automatically",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "description" =>
                "View exams student is eligible for (curriculum mapping)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "exam_taking",
            "description" =>
                "Manually submit/finalize exam before time expires",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "exam_taking",
            "description" =>
                "Log tab-switch/focus-loss events (system automatic)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "grading",
            "description" =>
                "System auto-grades MCQ/True-False immediately (automatic)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "grading",
            "description" =>
                "System auto-submits attempts at scheduled_end (background job)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "results",
            "description" =>
                "Release exam results to students (opens edit window)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "results",
            "description" =>
                "Revise grades within edit window (default 7 days)",
            "is_system_defined" => true,
        ]);
        ...
        Permission::create([
            ...
            "category" => "results",
            "description" =>
                "Revise grades after edit window (requires Admin approval)",
            "is_system_defined" => true,
        ]);
